...
use crate::header::names::{
    ...
    X_AMZ_SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5, X_AMZ_STORAGE_CLASS, X_AMZ_VERSION_ID,
...
pub fn extract(req: &Request, bucket: &str, key: &str) -> Result<HeadObjectRequest, BoxStdError> {
